...
public class MovieMagnetModule : AbpModule
{
    ...
    private void ConfigureVirtualFiles(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<MovieMagnetModule>();
            if (hostingEnvironment.IsDevelopment())
            {
                /* Using physical files in development, so we don't need to recompile on changes */
                options.FileSets.ReplaceEmbeddedByPhysical<MovieMagnetModule>(hostingEnvironment.ContentRootPath);
            }
        });
    }
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(MovieMagnetModule).Assembly);
        });
    }
    ...
    {
        context.Services.AddAutoMapperObjectMapper<MovieMagnetModule>();
        Configure<AbpAutoMapperOptions>(options =>
        {
             ...
             */
            options.AddMaps<MovieMagnetModule>(/* validate: true */);
        });
    }
